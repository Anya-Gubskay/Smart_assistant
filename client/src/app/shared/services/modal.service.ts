import { ApplicationRef, ComponentRef, EnvironmentInjector, Inject, Injectable, Injector, TemplateRef, createComponent} from '@angular/core';
...
export class ModalService {
  ...
  open<T>(component: ComponentType<any>, data?: T, options?: Common.OptionModal): Observable<any> {
