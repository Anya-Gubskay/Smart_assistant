...
export namespace AssortimentSelectors {
  ...
  export const getCategoriesLoadingStatus = createSelector(getState, (state) => state.categoriesLoadingStatus);

  export const getCategory = createSelector(getState, (state) => state.category);

  export const getCategoryLoadingStatus = createSelector(getState, (state) => state.categoryLoadingStatus);


  export const getPositions = createSelector(getState, (state) => state.positions);

  export const getPositionsLoadingStatus = createSelector(getState, (state) => state.positionsLoadingStatus);
}
