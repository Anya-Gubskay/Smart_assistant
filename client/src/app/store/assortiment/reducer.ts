...
export function assortimentReducer(
	state: AssortimentState = initialState,
	action: any
): AssortimentState {
	switch (action.type) {
		...
		case AssortimentActions.TYPES.GET_CATEGORIES.FAILED:
			return getDataLoaderReducer(
				AssortimentActions.TYPES.GET_CATEGORIES,
				'categories',
				state,
				action
			);
		...
		case AssortimentActions.TYPES.GET_CATEGORY.FAILED:
			return getDataLoaderReducer(
				AssortimentActions.TYPES.GET_CATEGORY,
				'category',
				state,
				action
			);
		...
		case AssortimentActions.TYPES.GET_POSITIONS_BY_CATEGORY.FAILED:
			return getDataLoaderReducer(
				AssortimentActions.TYPES.GET_POSITIONS_BY_CATEGORY,
				'positions',
				state,
				action
			);
