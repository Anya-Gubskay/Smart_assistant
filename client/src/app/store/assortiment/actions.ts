...
export namespace AssortimentActions {
  ...
  export class UpdatePosition extends ActionWithPayload<{position: Positions.PositionByCategory}> {
		override type = TYPES.UPDATE_POSITION_FOR_CATEGORY.REQUESTED;
	}

  export class UpdatePositionCompleted extends ActionWithPayload<{position: Positions.PositionByCategory}> {
		override type = TYPES.UPDATE_POSITION_FOR_CATEGORY.REQUESTED;
	}

  export class DeletePosition extends ActionWithPayload<{position: Positions.PositionByCategory}> {
